class DateTimeHelpers {
  ...
  static addTimeFrom(initial_date, {days = 0}) {
    Duration added_time = Duration(days: days);
    return getDate(initial_date.add(added_time));
  }

  static subtractTimeFrom(initial_date, {days: 0}) {
    Duration added_time = Duration(days: days);
    return getDate(initial_date.subtract(added_time));
  }
